...
QDEF(MP_QSTR_sine, (const byte*)"\xb4\x04" "sine")
QDEF(MP_QSTR_square, (const byte*)"\xc4\x06" "square")
QDEF(MP_QSTR_sawtooth, (const byte*)"\x68\x08" "sawtooth")
QDEF(MP_QSTR_Adder, (const byte*)"\xd3\x05" "Adder")
...
QDEF(MP_QSTR_make_buzzer, (const byte*)"\xd8\x0b" "make_buzzer")
QDEF(MP_QSTR_instrument, (const byte*)"\x30\x0a" "instrument")
QDEF(MP_QSTR_PhaseShifter, (const byte*)"\x3d\x0c" "PhaseShifter")
