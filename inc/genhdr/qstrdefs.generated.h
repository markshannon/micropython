...
QDEF(MP_QSTR_read_register, (const byte*)"\xa1\x0d" "read_register")
QDEF(MP_QSTR_events, (const byte*)"\x9a\x06" "events")
QDEF(MP_QSTR_event_stream, (const byte*)"\x6a\x0c" "event_stream")
QDEF(MP_QSTR_tick, (const byte*)"\x30\x04" "tick")
QDEF(MP_QSTR_drop_newest, (const byte*)"\xad\x0b" "drop_newest")
