...
QDEF(MP_QSTR_Add, (const byte*)"\x64\x03" "Add")
QDEF(MP_QSTR_Multiply, (const byte*)"\xa9\x08" "Multiply")
QDEF(MP_QSTR_Envelope, (const byte*)"\xcb\x08" "Envelope")
QDEF(MP_QSTR_Level, (const byte*)"\xf3\x05" "Level")
QDEF(MP_QSTR_LowPass, (const byte*)"\xc0\x07" "LowPass")
QDEF(MP_QSTR_Waveform, (const byte*)"\x16\x08" "Waveform")
QDEF(MP_QSTR_attack, (const byte*)"\x8d\x06" "attack")
QDEF(MP_QSTR_decay, (const byte*)"\x9f\x05" "decay")
QDEF(MP_QSTR_sustain, (const byte*)"\xc2\x07" "sustain")
QDEF(MP_QSTR_NOISE, (const byte*)"\xbb\x05" "NOISE")
QDEF(MP_QSTR_SINE, (const byte*)"\xf4\x04" "SINE")
QDEF(MP_QSTR_SAW, (const byte*)"\x80\x03" "SAW")
QDEF(MP_QSTR_RECTANGLE1, (const byte*)"\xf5\x0a" "RECTANGLE1")
QDEF(MP_QSTR_RECTANGLE2, (const byte*)"\xf6\x0a" "RECTANGLE2")
QDEF(MP_QSTR_RECTANGLE3, (const byte*)"\xf7\x0a" "RECTANGLE3")
QDEF(MP_QSTR_input, (const byte*)"\x73\x05" "input")
QDEF(MP_QSTR_press, (const byte*)"\xa2\x05" "press")
QDEF(MP_QSTR_SynthFrame, (const byte*)"\x40\x0a" "SynthFrame")
QDEF(MP_QSTR_Output, (const byte*)"\x7a\x06" "Output")
