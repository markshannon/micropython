...
QDEF(MP_QSTR_sound, (const byte*)"\xa6\x05" "sound")
QDEF(MP_QSTR_test, (const byte*)"\x33\x04" "test")
QDEF(MP_QSTR_Source, (const byte*)"\x98\x06" "Source")
QDEF(MP_QSTR_from_buffer, (const byte*)"\x6c\x0b" "from_buffer")
QDEF(MP_QSTR_play_source, (const byte*)"\x63\x0b" "play_source")
QDEF(MP_QSTR_SoundBytes, (const byte*)"\x5f\x0a" "SoundBytes")
QDEF(MP_QSTR_set_pins, (const byte*)"\x9c\x08" "set_pins")
QDEF(MP_QSTR_samples, (const byte*)"\x10\x07" "samples")
QDEF(MP_QSTR_Sample, (const byte*)"\xe3\x06" "Sample")
QDEF(MP_QSTR_get_buffer, (const byte*)"\xec\x0a" "get_buffer")
...
QDEF(MP_QSTR_Reverb, (const byte*)"\x31\x06" "Reverb")
QDEF(MP_QSTR_buckets, (const byte*)"\xd8\x07" "buckets")
QDEF(MP_QSTR_reflection, (const byte*)"\x42\x0a" "reflection")
QDEF(MP_QSTR_feedback, (const byte*)"\x8c\x08" "feedback")
QDEF(MP_QSTR_effects, (const byte*)"\xe1\x07" "effects")
