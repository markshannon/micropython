...
QDEF(MP_QSTR_PersistentData, (const byte*)"\x30\x0e" "PersistentData")
QDEF(MP_QSTR_persistent, (const byte*)"\x20\x0a" "persistent")
QDEF(MP_QSTR_save_script, (const byte*)"\x14\x0b" "save_script")
QDEF(MP_QSTR_script, (const byte*)"\xaa\x06" "script")
QDEF(MP_QSTR_page_size, (const byte*)"\xcc\x09" "page_size")
QDEF(MP_QSTR_erase, (const byte*)"\xe5\x05" "erase")
