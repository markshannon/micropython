...
QDEF(MP_QSTR_synth, (const byte*)"\x3d\x05" "synth")
QDEF(MP_QSTR_sine_wave, (const byte*)"\x8e\x09" "sine_wave")
QDEF(MP_QSTR_saw_wave, (const byte*)"\x1a\x08" "saw_wave")
QDEF(MP_QSTR_square_wave, (const byte*)"\x3e\x0b" "square_wave")
QDEF(MP_QSTR_triangle_wave, (const byte*)"\xf1\x0d" "triangle_wave")
QDEF(MP_QSTR_rectangular_wave, (const byte*)"\xbd\x10" "rectangular_wave")
QDEF(MP_QSTR_noise_wave, (const byte*)"\x81\x0a" "noise_wave")
QDEF(MP_QSTR_power4_wave, (const byte*)"\xd4\x0b" "power4_wave")
QDEF(MP_QSTR_step_wave, (const byte*)"\x4d\x09" "step_wave")
QDEF(MP_QSTR_fade_in, (const byte*)"\x5b\x07" "fade_in")
QDEF(MP_QSTR_wave, (const byte*)"\x20\x04" "wave")
QDEF(MP_QSTR_time, (const byte*)"\xf0\x04" "time")
QDEF(MP_QSTR_Instrument, (const byte*)"\x10\x0a" "Instrument")
QDEF(MP_QSTR_interrupts, (const byte*)"\x11\x0a" "interrupts")
QDEF(MP_QSTR_max_delay, (const byte*)"\xbb\x09" "max_delay")
QDEF(MP_QSTR_is_running, (const byte*)"\x87\x0a" "is_running")
QDEF(MP_QSTR_Envelope, (const byte*)"\xcb\x08" "Envelope")
QDEF(MP_QSTR_get_envelope, (const byte*)"\x62\x0c" "get_envelope")
QDEF(MP_QSTR_set_envelope, (const byte*)"\xf6\x0c" "set_envelope")
QDEF(MP_QSTR_get_source1, (const byte*)"\x60\x0b" "get_source1")
QDEF(MP_QSTR_get_detune1, (const byte*)"\xd6\x0b" "get_detune1")
QDEF(MP_QSTR_get_source2, (const byte*)"\x63\x0b" "get_source2")
QDEF(MP_QSTR_get_detune2, (const byte*)"\xd5\x0b" "get_detune2")
QDEF(MP_QSTR_get_volume1, (const byte*)"\x55\x0b" "get_volume1")
QDEF(MP_QSTR_get_volume2, (const byte*)"\x56\x0b" "get_volume2")
QDEF(MP_QSTR_get_filter1, (const byte*)"\x9d\x0b" "get_filter1")
QDEF(MP_QSTR_get_filter2, (const byte*)"\x9e\x0b" "get_filter2")
QDEF(MP_QSTR_set_source1, (const byte*)"\x74\x0b" "set_source1")
QDEF(MP_QSTR_set_detune1, (const byte*)"\xc2\x0b" "set_detune1")
QDEF(MP_QSTR_set_source2, (const byte*)"\x77\x0b" "set_source2")
QDEF(MP_QSTR_set_detune2, (const byte*)"\xc1\x0b" "set_detune2")
QDEF(MP_QSTR_set_volume1, (const byte*)"\x41\x0b" "set_volume1")
QDEF(MP_QSTR_set_volume2, (const byte*)"\x42\x0b" "set_volume2")
QDEF(MP_QSTR_set_filter1, (const byte*)"\x89\x0b" "set_filter1")
QDEF(MP_QSTR_set_filter2, (const byte*)"\x8a\x0b" "set_filter2")
QDEF(MP_QSTR_Component, (const byte*)"\x8a\x09" "Component")
QDEF(MP_QSTR_Oscillator, (const byte*)"\x7b\x0a" "Oscillator")
QDEF(MP_QSTR_LowPass, (const byte*)"\xc0\x07" "LowPass")
QDEF(MP_QSTR_BELL, (const byte*)"\x02\x04" "BELL")
QDEF(MP_QSTR_DRUM, (const byte*)"\xeb\x04" "DRUM")
QDEF(MP_QSTR_STRINGS, (const byte*)"\xe3\x07" "STRINGS")
QDEF(MP_QSTR_ORGAN, (const byte*)"\x50\x05" "ORGAN")
QDEF(MP_QSTR_BUZZER, (const byte*)"\x65\x06" "BUZZER")
